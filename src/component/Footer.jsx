...
const Footer = () => {
  ...
  return (
    <div className=" w-screen bg-[#242124] overflow-y-hidden mt-[10%]">
      <div className="hidden md:flex flex-col justify-center items-center mt-[5%] ">
        <div className=" w-[1440px] h-[650px]  ">
          ...
          <div className=" flex justify-between  mt-[5%]">
            <div>
              <div className="">
                <h4 className=" font-clash font-normal text-[24px] text-[#DDDDDD] leading-7">
                  Email
                </h4>
                <span className=" font-aileron font-normal text-[24px] text-[#FFFFFF] leading-7">
                  info@azerotech.com
                </span>
              </div>
              <div className=" mt-5">
            ...
            <div className=" mt-10">
              <div className=" flex gap-2">
                ...
                <div>
                  <img
                    src="/assets/azero-logo-white.svg"
                    className=" mt-1"
                    alt="azero-logo"
                  />
                </div>
        ...
        <div className="flex flex-col gap-10 md:flex-row justify-between">
          <div className="flex flex-col gap-4 md:w-1/3">
            ...
            <div>
              ...
              <span className="font-aileron text-base">
                Vellore, Tamil Nadu - 600 002
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 md:w-1/3">
            ...
            <div className="flex gap-4 mt-2">
              <img
                className="hover:scale-110 transition-transform w-6 h-6"
                src="/assets/Twitter → SVG.svg"
                alt="Twitter"
              />
              <img
